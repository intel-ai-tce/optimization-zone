...
> **Running in Kubernetes?** To assign PCT high-priority cores to specific pods, see [NRI Resource-Policy Plugins](../../software/kubernetes/nri-resource-policies/README.md).
